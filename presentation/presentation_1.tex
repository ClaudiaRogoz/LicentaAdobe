...
\title[Short title]{Managementul elementelor vizuale \\pentru aplicații mobile} % The short title appears at the bottom of every slide, the full title is only on the title page

\author{Claudia Rafaela Rogoz\\
  \textbf{Profesor coordonator}: Prof. Dr. Ing. Nicolae Țăpuș} % Your name
\institute[UCLA] % Your institution as it will appear on the bottom of every slide, may be shorthand to save space
{
Facultatea de Automatică și Calculatoare,
Universitatea Politehnică București \\ % Your institution for the title page
\medskip
}
...
\node (xd) at (0, 0) {\includegraphics[width=.40\textwidth]{img/tranzitie.png}};
\node (solutie) at (7, 0) {BlackBox Soluție};
\node (xcode) at (7, -5) {\includegraphics[width=.50\textwidth]{img/xcode.png}};
\draw [<->](solutie) -- (xd);
\draw [<->] (xcode) -- (solutie);
\end{tikzpicture}
