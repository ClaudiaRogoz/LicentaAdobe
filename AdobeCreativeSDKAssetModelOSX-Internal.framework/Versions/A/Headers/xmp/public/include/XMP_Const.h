...
enum SeekMode
{
    kXMP_SeekFromStart, kXMP_SeekFromCurrent, kXMP_SeekFromEnd
};
...
enum
{
    ...
    // *** This must only be used by AME and only for newly created, non-fragmented files!
...
enum
{
    kXMP_DerivedDocInfoVersion = 1
};                                          // *** Add versioning to the internal calls.
...
inline XMP_Bool      IsNotified() const
{
    return notified;
}

/// Sets the notification status for an error
inline void          SetNotified()
{
    notified = true;
}
