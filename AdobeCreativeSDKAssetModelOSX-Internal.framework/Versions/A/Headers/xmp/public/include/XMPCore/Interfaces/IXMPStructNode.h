...
virtual pIXMPArrayNode_latest SetArrayNode(const char *nameSpace, const char *name, eXMPArrayNodeForm form, pIError_latest & err) __NOTHROW__ = 0;
virtual pIXMPStructNode_latest SetStructNode(const char *nameSpace, const char *name, pIError_latest & err) __NOTHROW__ = 0;
