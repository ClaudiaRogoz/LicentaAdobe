...
{
public:
XMP_PRIVATE VIRTUAL_IF_SOURCE_COMPILED eUnResolvedConflictReason GetUnResolvedConflictReason() const;
...
protected:
virtual UInt32 GetUnResolvedConflictReason(pIError_base & err) const __NOTHROW__ = 0;
...
virtual ~IThreeWayUnResolvedConflict_v1() __NOTHROW__ = 0;
};

inline IThreeWayUnResolvedConflict_v1::~IThreeWayUnResolvedConflict_v1() __NOTHROW__
{
}
}
